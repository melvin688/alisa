...
CREATE TABLE IF NOT EXISTS orders (
    ...
    total_amount DECIMAL(10,2) NOT NULL COMMENT '总金额(MMK)',
    status ENUM('pending', 'preparing', 'completed', 'cancelled') DEFAULT 'pending' COMMENT '订单状态:待处理/制作中/已完成/已取消',
    payment_method VARCHAR(20) DEFAULT 'CASH' COMMENT '支付方式:CASH现金/KPAY',
    payment_status ENUM('unpaid', 'paid') DEFAULT 'unpaid' COMMENT '支付状态',
    remark TEXT COMMENT '备注',
    language VARCHAR(10) DEFAULT 'zh' COMMENT '下单语言:zh中文/my缅甸语/en英语',
    is_printed BOOLEAN DEFAULT FALSE COMMENT '是否已打印',
